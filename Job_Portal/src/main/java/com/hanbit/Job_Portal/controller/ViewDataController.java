...
Gson gson = new Gson();
	...
	@RequestMapping(value = "/applieddetails/{jobsrNo}/{JobProfile}", method = RequestMethod.GET, produces = "application/json")
	public @ResponseBody
	String listAppliedjob(@PathVariable("jobsrNo") int jobsrNo,@PathVariable("JobProfile") String JobProfile) throws SQLException {
		...
		fetchviewdetailslist = viewdao.getApplieddetails(jobsrNo,JobProfile); 
